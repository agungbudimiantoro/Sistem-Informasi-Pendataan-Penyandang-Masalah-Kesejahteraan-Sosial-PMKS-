<div class="row border p-2">
    <table>
        ...
        <tr>
            ...
            <td> <input type="text" name="nm_lkp" class="form-control" id="nm_lkp" aria-describedby="emailHelp" required></td>

            <td> <label style="text-transform:capitalize;" for="tmpt_lahir" class="form-label">tmpt lhr</label></td>
            <td> <input type="text" name="tmpt_lahir" class="form-control" id="tmpt_lahir" aria-describedby="emailHelp" required></td>

            <td><label style="text-transform:capitalize;" for="almt" class="form-label">almt</label></td>
            <td><input type="text" name="almt" class="form-control" id="almt" aria-describedby="emailHelp" required></td>
            <td>
        ...
        <tr>
            ...
            <td> <input type="text" name="nm_pgl" class="form-control" id="nm_pgl" aria-describedby="emailHelp" required></td>
            <td> <label style="text-transform:capitalize;" for="tgl_lahir" class="form-label">tgl lahir</label></td>
            <td> <input type="date" name="tgl_lahir" class="form-control" id="tgl_lahir" aria-describedby="emailHelp" required></td>
            <td> <label style="text-transform:capitalize;" for="cr_fisik" class="form-label">ciri-ciri fisik</label></td>
            <td colspan="3"><input type="text" name="cr_fisik" class="form-control" id="cr_fisik" aria-describedby="emailHelp" required></td>
        </tr>
        <tr>
            ...
            <td> <input type="number" name="umur" class="form-control" id="umur" aria-describedby="emailHelp" required></td>
            <td> <label style="text-transform:capitalize;" for="wrn_rmbt" class="form-label">warna rambut</label></td>
            <td> <input type="text" name="wrn_rmbt" class="form-control" id="wrn_rmbt" aria-describedby="emailHelp" required></td>
