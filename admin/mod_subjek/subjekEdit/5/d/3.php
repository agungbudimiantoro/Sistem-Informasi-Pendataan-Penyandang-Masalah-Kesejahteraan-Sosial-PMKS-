        ...
        <table>
            <tr>
                <td colspan="2">
                    ...
                    <input type="text" value="<?= $data['als_mks_npz'] ?>" <?php fungsiDisabled($p, 'disabled'); ?> class="mb-2" name="als_mks_npz" id="als_mks_npz">
                </td>
            </tr>
            <tr>
    ...
    <div class="col-md-8">
        <table>
            ...
            <tr>
                ...
                <td> <input type="text" value="<?= $data['sts_jns_pmks'] ?>" readonly name="sts_jns_pmks" class="form-control" id="sts_jns_pmks" aria-describedby="emailHelp"></td>
                ...
                <td> <input type="text" value="<?= $nm_user ?>" readonly <?php fungsiDisabled($p, 'disabled'); ?> name="petugas" class="form-control" id="petugas" aria-describedby="emailHelp"></td>
