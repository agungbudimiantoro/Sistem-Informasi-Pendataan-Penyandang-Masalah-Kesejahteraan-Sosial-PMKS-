    ...
    <div class="col-md-8">
        <table>
            ...
            <tr>
                ...
                <td> <input type="text" value="<?= $nm_user ?>" readonly <?php fungsiDisabled($p, 'disabled'); ?> name="petugas" class="form-control" id="petugas" aria-describedby="emailHelp" required></td>
            ...
            <tr>
                ...
                <td> <input type="date" value="<?= date("Y-m-d") ?>" readonly <?php fungsiDisabled($p, 'disabled'); ?> name="tgl_pendataan" class="form-control" id="tgl_pendataan" aria-describedby="emailHelp" required></td>
                <td style="padding-top:20px;" align="right"> <label style="text-transform:capitalize;" for="jam" class="form-label">jam</label></td>
                <td> <input type="time" value="<?= date("H:i") ?>" readonly <?php fungsiDisabled($p, 'disabled'); ?> name="jam" class="form-control" id="jam" aria-describedby="emailHelp" required></td>
