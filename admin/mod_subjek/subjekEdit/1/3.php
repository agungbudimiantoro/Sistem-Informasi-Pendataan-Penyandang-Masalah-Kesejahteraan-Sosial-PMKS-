...
<div class="row border">
    <div class="col-md-6 border">
        ...
        <?php for ($i = 0; $i < count($array_pmpln); $i++) : ?>
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" <?php if ($data['pmpln'] == $data_for) {
                                                                    echo "checked";
                                                                };
                                                                fungsiDisabled($p, 'disabled'); ?> name="pmpln" id="pmpln" value="<?= $data_for ?>">
    ...
    <div class="col-md-6 border">
        ...
        <?php for ($i = 0; $i < count($array_kmp_bcr); $i++) : ?>
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" <?php if ($data['kmp_bcr'] == $data_for) {
                                                                    echo "checked";
                                                                };
                                                                fungsiDisabled($p, 'disabled'); ?> name="kmp_bcr" id="kmp_bcr" value="<?= $data_for ?>">
