<div class="row border p-2">
    <table>
        ...
        <tr>
            ...
            <td> <input value="<?= $data['nm_lkp'] ?>" <?php fungsiDisabled($p, 'readonly'); ?> type="text" name="nm_lkp" class="form-control" id="nm_lkp" aria-describedby="emailHelp" required></td>

            <td> <label style="text-transform:capitalize;" for="tmpt_lahir" class="form-label">tmpt lhr</label></td>
            <td> <input value="<?= $data['tmpt_lahir'] ?>" <?php fungsiDisabled($p, 'readonly'); ?> type="text" name="tmpt_lahir" class="form-control" id="tmpt_lahir" aria-describedby="emailHelp" required></td>

            <td><label style="text-transform:capitalize;" for="almt" class="form-label">almt</label></td>
            <td><input value="<?= $data['almt'] ?>" <?php fungsiDisabled($p, 'readonly'); ?> type="text" name="almt" class="form-control" id="almt" aria-describedby="emailHelp" required></td>
            <td>
                <label style="text-transform:capitalize;" for="exampleInputPassword1" class="form-label">kcmtan</label>
            </td>
            <td>
                <select class="form-select" <?php fungsiDisabled($p, 'disabled'); ?> aria-label="Default select example" name="kecamatan" required>
        ...
        <tr>
            ...
            <td> <input value="<?= $data['nm_pgl'] ?>" <?php fungsiDisabled($p, 'readonly'); ?> type="text" name="nm_pgl" class="form-control" id="nm_pgl" aria-describedby="emailHelp" required></td>
            <td> <label style="text-transform:capitalize;" for="tgl_lahir" class="form-label">tgl lahir</label></td>
            <td> <input value="<?= $data['tgl_lahir'] ?>" <?php fungsiDisabled($p, 'readonly'); ?> type="date" name="tgl_lahir" class="form-control" id="tgl_lahir" aria-describedby="emailHelp" required></td>
            <td> <label style="text-transform:capitalize;" for="cr_fisik" class="form-label">ciri-ciri fisik</label></td>
            <td colspan="3"><input value="<?= $data['cr_fisik'] ?>" <?php fungsiDisabled($p, 'readonly'); ?> type="text" name="cr_fisik" class="form-control" id="cr_fisik" aria-describedby="emailHelp" required></td>
        </tr>
        <tr>
            ...
            <td>
                <select class="form-select" <?php fungsiDisabled($p, 'disabled'); ?> aria-label="Default select example" name="jk" required>
            ...
            <td> <input value="<?= $data['umur'] ?>" <?php fungsiDisabled($p, 'readonly'); ?> type="number" name="umur" class="form-control" id="umur" aria-describedby="emailHelp" required></td>
            <td> <label style="text-transform:capitalize;" for="wrn_rmbt" class="form-label">warna rambut</label></td>
            <td> <input value="<?= $data['wrn_rmbt'] ?>" <?php fungsiDisabled($p, 'readonly'); ?> type="text" name="wrn_rmbt" class="form-control" id="wrn_rmbt" aria-describedby="emailHelp" required></td>
            <td><label style="text-transform:capitalize;" for="btk_rmbt" class="form-label">bentuk rambut</label></td>
            <td> <input value="<?= $data['btk_rmbt'] ?>" <?php fungsiDisabled($p, 'readonly'); ?> type="text" name="btk_rmbt" class="form-control" id="btk_rmbt" aria-describedby="emailHelp" required></td>
        </tr>
    </table>
</div>