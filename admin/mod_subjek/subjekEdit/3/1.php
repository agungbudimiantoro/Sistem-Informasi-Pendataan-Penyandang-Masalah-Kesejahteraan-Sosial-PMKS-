...
<div class="row border">
    ...
    <div class="col-md-4 border">
        ...
        <?php for ($i = 0; $i < count($array_sts_sklh); $i++) : ?>
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" <?php if ($data['sts_sklh'] == $data_for) {
                                                                    echo "checked";
                                                                };
                                                                fungsiDisabled($p, 'disabled'); ?> name="sts_sklh" id="sts_sklh" value="<?= $data_for ?>">
    ...
    <div class="col-md-8 border">
        ...
        <?php for ($i = 0; $i < count($array_niat_ljt_sklh); $i++) : ?>
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" <?php if ($data['niat_ljt_sklh'] == $data_for) {
                                                                    echo "checked";
                                                                };
                                                                fungsiDisabled($p, 'disabled'); ?> name="niat_ljt_sklh" id="niat_ljt_sklh" value="<?= $data_for ?>">
