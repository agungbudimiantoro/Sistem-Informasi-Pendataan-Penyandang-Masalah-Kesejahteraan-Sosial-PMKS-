    ...
    <div class="col-md-8">
        <table>
            ...
            <tr>
                ...
                <td> <input type="text" value="<?= $data['sts_jns_pmks'] ?>" <?php fungsiDisabled($p, 'disabled'); ?> name="sts_jns_pmks" class="form-control" id="sts_jns_pmks" aria-describedby="emailHelp" required></td>
                ...
                <td> <input type="text" value="<?= $id_user ?>" <?php fungsiDisabled($p, 'disabled'); ?> name="petugas" class="form-control" id="petugas" aria-describedby="emailHelp" required></td>
