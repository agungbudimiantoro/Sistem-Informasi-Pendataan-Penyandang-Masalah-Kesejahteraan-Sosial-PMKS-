    ...
    <div class="col-md-12 border">
        ...
        <?php for ($i = 0; $i < count($array_dpt_kkrs_fm); $i++) : ?>
            ...
            <div class="form-check form-check-inline">
                <input required class="form-check-input" type="radio" <?php if ($data['dpt_kkrs_fm'] == $data_for) {
                                                                            echo "checked";
                                                                        };
                                                                        fungsiDisabled($p, 'disabled'); ?> name="dpt_kkrs_fm" id="dpt_kkrs_fm" value="<?= $data_for ?>">
