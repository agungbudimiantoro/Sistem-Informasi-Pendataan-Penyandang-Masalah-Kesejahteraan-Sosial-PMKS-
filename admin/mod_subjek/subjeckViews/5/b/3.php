...
<div class="row border">
    ...
    <div class="col-md-6 border">
        ...
        <?php for ($i = 0; $i < count($array_niat_brht); $i++) : ?>
            ...
            <div class="form-check form-check-inline">
                <input required class="form-check-input" type="radio" <?php if ($data['niat_brht'] == $data_for) {
                                                                            echo "checked";
                                                                        };
    ...
    <div class="col-md-6 border">
        ...
        <input type="text" class="mb-2" value="<?= $data['cr_brht'] ?>" <?php fungsiDisabled($p, 'disabled'); ?> name="cr_brht" id="cr_brht" size="50" required>
    </div>
</div>